                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="./episodes.php"><li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> Back to Episodes</li></a>
                                </ol>
                            </div>
                            <h4 class="page-title">Mass Edit Episodes <small id="selected_count"></small></h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            Mass edit of Episodes was successfully executed!
                        </div>
                                            ...
                                            <div class="tab-pane" id="stream-selection">
                                                <div class="row">
                                                    <div class="col-md-3 col-6">
                                                        <input type="text" class="form-control" id="stream_search" value="" placeholder="Search Episodes...">
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
														...
														<div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="serie_name">Series Name</label>
                                                            <div class="col-md-8">
