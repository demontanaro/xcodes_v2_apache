                            ...
                            <div class="card-body" style="overflow-x:auto;">
                                <form id="episodes_form">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" id="episodes_search" value="" placeholder="Search Episodes...">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <label class="col-md-1 col-form-label text-center" for="episodes_show_entries">Show</label>
                                        <div class="col-md-2">
