...
if (isset($_POST["submit_profile"])) {
    ...
    if (!isset($_STATUS)) {
		...
		$db->query("UPDATE `reg_users` SET `password` = '".$db->real_escape_string($rPassword)."', `email` = '".$db->real_escape_string($rEmail)."', `reseller_dns` = '".$db->real_escape_string($rDNS)."', `dark_mode` = ".intval($rDarkMode).", `sidebar` = ".intval($rSidebar)." WHERE `id` = ".intval($rUserInfo["id"]).";");
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            Profile was successfully modified.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            Please ensure you enter your new password is <strong><?=intval($rAdminSettings["pass_length"])?></strong> characters or longer.
                        </div>
                                            ...
                                            <div class="tab-pane" id="user-details">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="password">Change Password</label>
                                                            <div class="col-md-8">
														...
														<?php } ?>
														<div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="dark_mode">Dark Mode</label>
                                                            <div class="col-md-2">
															...
															<label class="col-md-4 col-form-label" for="sidebar">Sidebar Nav</label>
                                                            <div class="col-md-2">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    <li class="list-inline-item float-right">
                                                        <input name="submit_profile" type="submit" class="btn btn-primary" value="Save Profile" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> <!-- tab-content -->
